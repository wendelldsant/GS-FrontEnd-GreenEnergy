...
function CardTecnologias({ dadosCards }) {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 p-2 sm:p-0">
            {dadosCards.map((card, index) => (
                <div key={index} className="my-5">
                    <div className="opacity-75 group flex p-2 flex-col justify-between w-10/12 sm:w-11/12 mx-auto items-start gap-2 h-full duration-500 relative rounded-lg bg-gray-100 hover:-translate-y-2 hover:shadow-xl shadow-gray-300">
