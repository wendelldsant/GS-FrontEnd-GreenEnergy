...
const Button = ({onClick , text}) => {
  return (
    <button onClick={onClick} className="min-w-24 mx-4 lg:mx-10 min-h-9 relative inline-flex items-center justify-center px-8 py-2.5 overflow-hidden tracking-tighter text-white bg-gray-800 rounded-md group">
